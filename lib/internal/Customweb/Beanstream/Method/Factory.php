 ...
 * @Bean
 */
class Customweb_Beanstream_Method_Factory extends Customweb_Payment_Authorization_Method_AbstractFactory{
	
	protected function getMethodPackages() {
		return array('Customweb_Beanstream_Method');
	}
	
	/**
	 * @return Customweb_Beanstream_Method_DefaultMethod
	 */
