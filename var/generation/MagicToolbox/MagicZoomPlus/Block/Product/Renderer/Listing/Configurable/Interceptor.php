<?php
namespace MagicToolbox\MagicZoomPlus\Block\Product\Renderer\Listing\Configurable;

/**
 * Interceptor class for @see \MagicToolbox\MagicZoomPlus\Block\Product\Renderer\Listing\Configurable
 */
class Interceptor extends \MagicToolbox\MagicZoomPlus\Block\Product\Renderer\Listing\Configurable implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMagicToolboxHelper');
        if (!$pluginInfo) {
            return parent::getMagicToolboxHelper();
        } else {
            return $this->___callPlugins('getMagicToolboxHelper', func_get_args(), $pluginInfo);
        }
    }
