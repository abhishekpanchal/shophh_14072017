...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $elements['separator_one'] = $fieldset->addField(
            ...
            'note',
            [
                'text' => __('Slider General Configuration'),
            ]
        );
        ...
        $elements['items'] =$fieldset->addField(
            ...
            [
                ...
                'note'     => 'The number of items you want to see on the screen.'
            ]
        );
        ...
        $elements['loop'] = $fieldset->addField(
            ...
            [
                ...
                'note'     => 'Inifnity loop. Duplicate last and first items to get loop illusion.'
            ]
        );
        ...
        $elements['lazyLoad'] = $fieldset->addField(
            ...
            [
                ...
                'note'     => 'Lazy load images. data-src and data-src-retina for highres. 
                               Also load images into background inline style if element is not img element.'
            ]
        );
        ...
        $elements['separator_two'] = $fieldset->addField(
            ...
            'note',
            [
               'text' => __('Slider Responsive Breakpoint. This configuration will overwrite the main slider options.'),
            ]
        );
        ...
        $elements['items_brk1'] = $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'class'    => 'validate-greater-than-zero',
                'note'     => 'The number of items you want to set from the smallest screens to the widest.'
            ]
        );
