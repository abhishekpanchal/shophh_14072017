...
class BlockProductList
{
        ...
        )
    {
        ...
        if ($isEnabled) {
            ...
            return $result . '<a class="weltpixel-quickview '.$buttonStyle.' quickview-main-btn" data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><span><i class="mdi mdi-magnify"></i></span></a>';
        }
