...
*/
    ...
    public function getModuleTables() 
    {
        ...
        "Lof_Gallery" => ["lof_gallery_category","lof_gallery_category_store","lof_gallery_albumn","lof_gallery_albumn_category","lof_gallery_albumn_product", "lof_gallery_albumn_tag"]
        ];
        return $sql_tables;
    }
}