...
class Add extends \Magento\Framework\App\Action\Action
{
    ...
    {   
        ...
        if(isset($data['g-recaptcha-response'])){
            ...
            $secretKey = $this->_faqHelper->getConfig('recaptcha_settings/captcha_privatekey');
        ...
        try {
            ...
            $this->messageManager->addSuccess(__('You question has upload sucessfully, we will answer that as soon as possible'));
