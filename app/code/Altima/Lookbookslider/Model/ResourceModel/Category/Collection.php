...
namespace Altima\Lookbookslider\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection {
    ...
    protected function _construct() {
        parent::_construct();
        $this->_init('Altima\Lookbookslider\Model\Category', 'Altima\Lookbookslider\Model\ResourceModel\Category');
    ...
    protected function _afterLoad() {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('altima_lookbookslider_category_store')])
    ...
    protected function _renderFiltersBefore() {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                    ['store_table' => $this->getTable('altima_lookbookslider_category_store')], 'main_table.category_id = store_table.category_id', []
            )->group(
