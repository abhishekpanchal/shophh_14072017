...
class MagicScrollModuleCoreClass extends \stdClass
{
    ...
    public function getHeadersTemplate($jsPath = '', $cssPath = null, $linkModuleCss = true)
    {
        ...
        $headers = [];
        // add module version
        $headers[] = '<!-- Magic Zoom Plus Magento 2 module version v1.5.9 [v1.6.42:v5.1.17] -->';
    ...
    public function loadDefaults()
    {
        $params = [
            ...
            "selectorTrigger"=>["id"=>"selectorTrigger","advanced"=>"1","group"=>"Multiple images","order"=>"10","default"=>"click","label"=>"Switch between images on","description"=>"Mouse event used to swtich between multiple images.","type"=>"array","subType"=>"radio","values"=>["click","hover"],"scope"=>"magiczoomplus","desktop-only"=>""],
