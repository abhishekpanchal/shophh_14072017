...
class InstallData implements \Magento\Framework\Setup\InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $data = [];
        $moduleEtcPath = $this->_modulesReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR, 'MagicToolbox_MagicScroll');
        ...
        if ($setup->tableExists('magicscroll_config')) {
            $setup->getConnection()->insertMultiple($setup->getTable('magicscroll_config'), $data);
        }
