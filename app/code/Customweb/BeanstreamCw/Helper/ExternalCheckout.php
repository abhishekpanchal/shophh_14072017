...
namespace Customweb\BeanstreamCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	 ...
	 */
	public function saveOrder(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context)
	{
		$context->getQuote()->collectTotals()->save();

		$isNewCustomer = false;
		switch ($context->getRegisterMethod()) {
			case \Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
