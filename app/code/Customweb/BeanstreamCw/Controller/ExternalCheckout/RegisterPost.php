...
namespace Customweb\BeanstreamCw\Controller\ExternalCheckout;

class RegisterPost extends \Customweb\BeanstreamCw\Controller\ExternalCheckout
{
	/**
	...
	{
		if (!($this->getContext() instanceof \Customweb\BeanstreamCw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
