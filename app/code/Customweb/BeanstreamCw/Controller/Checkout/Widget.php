...
class Widget extends \Customweb\BeanstreamCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\BeanstreamCw\Model\Authorization\Method\Widget */
		...
		$resultPage->getLayout()
			->getBlock('customweb_beanstreamcwcheckout_widget')
