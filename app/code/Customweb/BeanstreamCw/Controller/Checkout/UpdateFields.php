 ...
 *
 */
namespace Customweb\BeanstreamCw\Controller\Checkout;

class UpdateFields extends \Customweb\BeanstreamCw\Controller\Checkout {
	/**
	 *
	...
	/**
	 *
	 * @var \Customweb\BeanstreamCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Payment\Method\ConfigProvider $configProvider
	 */
	public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Magento\Checkout\Model\Session $checkoutSession, \Magento\Quote\Api\CartRepositoryInterface $quoteRepository, \Customweb\BeanstreamCw\Model\Authorization\TransactionFactory $transactionFactory, \Customweb\BeanstreamCw\Model\Authorization\Method\Factory $authorizationMethodFactory, \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory, \Magento\Payment\Helper\Data $paymentHelper, \Customweb\BeanstreamCw\Model\Payment\Method\ConfigProvider $configProvider){
