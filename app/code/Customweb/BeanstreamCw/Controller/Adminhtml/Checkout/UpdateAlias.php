...
namespace Customweb\BeanstreamCw\Controller\Adminhtml\Checkout;

class UpdateAlias extends \Customweb\BeanstreamCw\Controller\Adminhtml\Checkout
{
	/**
	...
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\Payment\Method\ConfigProvider $configProvider
	) {
	...
	public function execute()
	{
		...
		$block = $this->_layout->createBlock('Customweb\BeanstreamCw\Block\Adminhtml\Checkout\Payment\Form');
