...
namespace Customweb\BeanstreamCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_BeanstreamCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Beanstream', 'Beanstream');
		$resultPage->addBreadcrumb(__('Beanstream Transactions'), __('Beanstream Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\BeanstreamCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('beanstreamcw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_BeanstreamCw::transactions');
	}
}