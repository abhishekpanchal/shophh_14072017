...
namespace Customweb\BeanstreamCw\Controller\Adminhtml\Config;

class Save extends \Customweb\BeanstreamCw\Controller\Adminhtml\Config
{
	...
	private function storeConfigState()
	{
		...
		$storedConfigState = $storage->read(\Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY);
		...
		$storage->write(\Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY, $updatedConfigState);
	}
