...
namespace Customweb\BeanstreamCw\Model\Service;

class TransactionRepository implements \Customweb\BeanstreamCw\Api\TransactionRepositoryInterface
{
	/**
     * @var \Customweb\BeanstreamCw\Model\Authorization\TransactionRegistry
     */
    ...
    /**
     * @var \Customweb\BeanstreamCw\Api\Data\TransactionInterfaceFactory
     */
	...
	/**
	 * @param \Customweb\BeanstreamCw\Model\Authorization\TransactionRegistry $transactionRegistry
	 * @param \Customweb\BeanstreamCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\BeanstreamCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	 * @param \Magento\Customer\Api\Data\CustomerSearchResultsInterfaceFactory $searchResultsFactory
	 * @param \Magento\Framework\Api\DataObjectHelper $dataObjectHelper
	 */
	public function __construct(
			\Customweb\BeanstreamCw\Model\Authorization\TransactionRegistry $transactionRegistry,
			\Customweb\BeanstreamCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\BeanstreamCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\BeanstreamCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\BeanstreamCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\BeanstreamCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\BeanstreamCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
