...
namespace Customweb\BeanstreamCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\BeanstreamCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\BeanstreamCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('beanstreamcw_form');
