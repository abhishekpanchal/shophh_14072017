 ...
 * @method \Customweb\BeanstreamCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\BeanstreamCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\BeanstreamCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_storage';
    ...
    {
        $this->_init('Customweb\BeanstreamCw\Model\ResourceModel\Storage');
    }
