...
namespace Customweb\BeanstreamCw\Model\Adapter;
...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'beanstreamcw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_BeanstreamCw::css/beanstreamcw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'beanstreamcw.main.content', 'content')->setText($content);
	}
