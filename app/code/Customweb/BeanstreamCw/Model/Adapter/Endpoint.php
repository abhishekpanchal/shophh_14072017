...
class Endpoint extends \Customweb_Payment_Endpoint_AbstractAdapter
{
	...
	protected function getBaseUrl() {
		return $this->_frontendUrlBuilder->setScope($this->_configuration->getStore())->getUrl('beanstreamcw/endpoint/index', ['_secure' => true, '_nosid' => true]);
	}
	...
	public function getFormRenderer() {
		return new \Customweb\BeanstreamCw\Model\Renderer\FrontendForm();
	}
}