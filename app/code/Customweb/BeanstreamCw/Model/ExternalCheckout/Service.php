...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\ExternalCheckout\ContextFactory
	 */
	protected $_contextFactory;

	/**
	 * @var \Customweb\BeanstreamCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\BeanstreamCw\Model\ExternalCheckout\ContextFactory $contextFactory
	 * @param \Customweb\BeanstreamCw\Helper\ExternalCheckout $helper
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\ExternalCheckout\ContextFactory $contextFactory,
			\Customweb\BeanstreamCw\Helper\ExternalCheckout $helper,
			...
			\Customweb\BeanstreamCw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\BeanstreamCw\Model\DependencyContainer $container
	 * @return \Customweb\BeanstreamCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\BeanstreamCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\BeanstreamCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\BeanstreamCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('beanstreamcw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\BeanstreamCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('beanstreamcw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\BeanstreamCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['beanstreamcw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_beanstreamcw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			/* @var $transaction \Customweb\BeanstreamCw\Model\Authorization\Transaction */
			$transaction = $this->_coreRegistry->registry('beanstreamcw_transaction');
