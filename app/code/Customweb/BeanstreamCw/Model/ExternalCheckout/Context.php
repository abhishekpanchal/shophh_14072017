...
/**
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\BeanstreamCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\BeanstreamCw\Helper\InvoiceItem
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_external_checkout_context';
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod
	 */
    ...
    protected function _construct() {
        $this->_init('Customweb\BeanstreamCw\Model\ResourceModel\ExternalCheckout\Context');
    }
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\BeanstreamCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod) {
			$data = [
