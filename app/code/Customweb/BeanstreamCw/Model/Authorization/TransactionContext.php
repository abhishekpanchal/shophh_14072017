	...
	\Customweb_Payment_Authorization_IUpdateTransactionContext
{
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory
	 */
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\OrderContext
	 */
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory $customerContextFactory
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction
	 * @param \Customweb\BeanstreamCw\Model\Authorization\OrderContext $orderContext
	 * @param int $orderId
	...
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory $customerContextFactory,
			\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction,
			\Customweb\BeanstreamCw\Model\Authorization\OrderContext $orderContext,
			$orderId,
		...
		$this->backendSuccessUrl = $backendHelper->getUrl('beanstreamcw/checkout/success');
		$this->backendFailureUrl = $backendHelper->getUrl('beanstreamcw/checkout/failure');
	}
	...
	{
		$this->_transactionFactory = \Magento\Framework\App\ObjectManager::getInstance()->get('Customweb\BeanstreamCw\Model\Authorization\TransactionFactory');
		$this->_customerContextFactory = \Magento\Framework\App\ObjectManager::getInstance()->get('Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory');
	}
	...
	{
		return $this->getTransaction()->getStore()->getUrl('beanstreamcw/checkout/success', ['_secure' => true]);
	}

	public function getFailedUrl()
	{
		return $this->getTransaction()->getStore()->getUrl('beanstreamcw/checkout/failure', ['_secure' => true]);
	}

	public function getIframeBreakOutUrl()
	{
		return $this->getTransaction()->getStore()->getUrl('beanstreamcw/checkout/breakout', ['_secure' => true]);
	}
	...
	{
		if (!($this->cachedTransaction instanceof \Customweb\BeanstreamCw\Model\Authorization\Transaction)) {
