...
use \Customweb\BeanstreamCw\Api\Data\TransactionInterface;

/**
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\BeanstreamCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'beanstreamcw_transaction';
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\Method\Factory
	 */
	protected $_authorizationMethodFactory;

	/**
	 * @var \Customweb\BeanstreamCw\Model\Alias\Handler
	 */
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param \Customweb\BeanstreamCw\Model\Alias\Handler $aliasHandler
	...
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\Alias\Handler $aliasHandler,
	...
	{
		$this->_init('Customweb\BeanstreamCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\BeanstreamCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\BeanstreamCw\Model\Authorization\Method\AbstractMethod */
