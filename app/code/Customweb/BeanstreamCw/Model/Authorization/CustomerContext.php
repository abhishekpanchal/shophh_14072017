 ...
 * @method \Customweb\BeanstreamCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\BeanstreamCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\BeanstreamCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\BeanstreamCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_customer_context';
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\BeanstreamCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\BeanstreamCw\Model\Authorization\CustomerContext
     */
