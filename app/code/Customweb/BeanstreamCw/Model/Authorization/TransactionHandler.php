...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\BeanstreamCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
