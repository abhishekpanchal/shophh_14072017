...
class Factory
{
     ...
     * @return \Customweb\BeanstreamCw\Model\Authorization\Method\AbstractMethod
     */
    public function create(\Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\BeanstreamCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\BeanstreamCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\BeanstreamCw\Model\Authorization\Method\Context\Factory
     */
