...
namespace Customweb\BeanstreamCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\BeanstreamCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\BeanstreamCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\BeanstreamCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\BeanstreamCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\BeanstreamCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\BeanstreamCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\BeanstreamCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
		...
		$this->_checkoutSession->unsBeanstreamCwCheckoutId();
	...
	/**
	 * @param \Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction
	 */
	public function finishAuthorization()
	{
		if ($this->getContext()->getTransaction()->getTransactionObject()->isAuthorized()) {
			if ($this->getContext()->getPaymentMethod() instanceof \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod) {
				$this->_coreRegistry->register('beanstreamcw_authorization_transaction', $this->getContext()->getTransaction());
	...
	/**
	 * @return \Customweb\BeanstreamCw\Model\Authorization\Transaction|null
	 */
