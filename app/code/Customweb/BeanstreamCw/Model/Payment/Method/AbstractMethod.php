...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\BeanstreamCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\BeanstreamCw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Configuration $configuration
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('beanstreamcw_transaction');
		if ($transaction instanceof \Customweb\BeanstreamCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('beanstreamcw/checkout/error', [
			'_secure' => true,
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		if ($transaction->getId()) {
			$invoice = $this->_registry->registry('beanstreamcw_invoice');
