...
namespace Customweb\BeanstreamCw\Model\Alias;
...
class Handler
{
	 ...
	 */
	public function getAliasTransactions(\Customweb\BeanstreamCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws Exception
	 */
	public function deactivateAlias(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
