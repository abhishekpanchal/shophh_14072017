...
namespace Customweb\BeanstreamCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\BeanstreamCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_beanstreamcw_external_checkout_context', 'context_id');
    }
