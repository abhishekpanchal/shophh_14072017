...
namespace Customweb\BeanstreamCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\BeanstreamCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_beanstreamcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\BeanstreamCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_beanstreamcw_transaction', 'entity_id');
    }
