...
define(
    [
        ...
        'Customweb_BeanstreamCw/js/checkout',
        'Customweb_BeanstreamCw/js/authorizationMethod',
        'Customweb_BeanstreamCw/js/storage',
        'Customweb_BeanstreamCw/js/alias',
    ...
    function ($, Component, mageTemplate, url, errorProcessor, Form, AuthorizationMethod, Storage, Alias, placeOrderAction, additionalValidators) {
        ...
        return Component.extend({
            defaults: {
                template: 'Customweb_BeanstreamCw/payment/beanstreamcw_americanexpress',
                fieldErrorTemplate: '<div for="<%- id %>" generated="true" class="mage-error" id="<%- id %>-error"><%- message %></div>',
                authorizationUrl: url.build('beanstreamcw/checkout/authorize/'),
                updateAliasUrl: url.build('beanstreamcw/checkout/updateAlias/'),
                updateVisibleFieldsUrl: url.build('beanstreamcw/checkout/updateFields/')
            },
