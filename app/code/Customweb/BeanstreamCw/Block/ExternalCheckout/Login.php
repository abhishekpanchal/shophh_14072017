...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BeanstreamCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('beanstreamcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('beanstreamcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('beanstreamcw/externalCheckout/registerPost', ['_secure' => true]);
	}
