...
namespace Customweb\BeanstreamCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BeanstreamCw::beanstreamcw/config/form.phtml';

	/**
	 * @var \Customweb\BeanstreamCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\BeanstreamCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\BeanstreamCw\Model\Config\Structure $formStructure,
			\Customweb\BeanstreamCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
