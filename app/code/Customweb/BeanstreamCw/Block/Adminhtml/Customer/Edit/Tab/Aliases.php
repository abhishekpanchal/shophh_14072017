...
namespace Customweb\BeanstreamCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\BeanstreamCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\BeanstreamCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\BeanstreamCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('beanstreamcw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('beanstreamcw/customer/aliases', ['_current' => true]);
    }
