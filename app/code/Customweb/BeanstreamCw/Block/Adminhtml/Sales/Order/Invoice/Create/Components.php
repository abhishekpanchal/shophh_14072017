...
namespace Customweb\BeanstreamCw\Block\Adminhtml\Sales\Order\Invoice\Create;
...
class Components extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BeanstreamCw::sales/order/invoice/create/components.phtml';
	...
	public function canCaptureNoClose()
	{
		...
		if (!($invoice->getOrder()->getPayment()->getMethodInstance() instanceof \Customweb\BeanstreamCw\Model\Payment\Method\AbstractMethod)) {
			return false;
		}
