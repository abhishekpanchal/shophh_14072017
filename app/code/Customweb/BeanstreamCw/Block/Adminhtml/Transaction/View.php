...
namespace Customweb\BeanstreamCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('beanstreamcw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('beanstreamcw_transaction');
	}
	...
	{
		return $this->getUrl('beanstreamcw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('beanstreamcw/transaction/');
	}
}