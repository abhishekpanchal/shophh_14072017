...
class Http
{
	...
	/**
	 * @var \Customweb\BeanstreamCw\Model\Adapter\StorageBackend
	 */
	private $_storage;
	 ...
	 * @param \Customweb\BeanstreamCw\Model\Adapter\StorageBackend $storage
	 */
	public function __construct(
			\Magento\Framework\Filesystem\DirectoryList $directoryList,
			\Magento\Framework\UrlInterface $urlBuilder,
			\Customweb\BeanstreamCw\Model\Adapter\StorageBackend $storage
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\BeanstreamCw\Model\TranslationResolver());
	}
