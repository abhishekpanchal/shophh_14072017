    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Hhmedia\TagsModel\Tags */
        ...
        $form->setHtmlIdPrefix('tags_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_tags_edit_tab_content_prepare_form', ['form' => $form]);
