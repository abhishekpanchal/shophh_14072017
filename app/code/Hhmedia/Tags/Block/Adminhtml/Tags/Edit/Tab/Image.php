    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'tags_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_tags_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Hhmedia\Tags\Block\Adminhtml\Form\Element\Image'];
    }
}
