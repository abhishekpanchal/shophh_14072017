...
{
    /**
     * Path to store config where count of tags posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'tags/view/items_per_page';
    ...
    /**
     * Remove Tags item image by image filename
     *
    ...
    /**
     * Return the base media directory for Tags Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Tags Item images
     *
     * @return string
     */
