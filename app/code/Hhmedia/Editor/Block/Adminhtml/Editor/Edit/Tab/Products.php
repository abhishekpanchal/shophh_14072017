...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {   
        ...
        if ($this->getRequest()->getParam('editor_id')) {
    ...
    { 
        $model = $this->_objectManager->get('\Hhmedia\Editor\Model\Editor');
    ...
    protected function _getSelectedProducts()
    {
        ...
        return $editor->getProducts($editor);
    }
    ...
    {
        $editor = $this->getEditor();
        $selected = $editor->getProducts($editor);
    ...
    {
        $editorId = $this->getRequest()->getParam('editor_id');
