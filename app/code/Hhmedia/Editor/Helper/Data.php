 ...
 * Editor data helper
 */
namespace Hhmedia\Editor\Helper;
...
{
    /**
     * Path to store config where count of editor posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'editor/view/items_per_page';
    ...
    /**
     * Remove Editor item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Hhmedia\Editor\Model\Editor $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Editor Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Editor Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getEditorPerPage()
    {
    ...
    { 
        return $this->_backendUrl->getUrl('editor/index/products', ['_current' => true]);
    }
