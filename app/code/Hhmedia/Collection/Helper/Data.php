 ...
 */
namespace Hhmedia\Collection\Helper;
...
{
    /**
     * Path to store config where count of collection posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'collection/view/items_per_page';
    ...
    /**
     * Remove Collection item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Hhmedia\Collection\Model\Collection $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Collection Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Collection Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCollectionPerPage()
    {
