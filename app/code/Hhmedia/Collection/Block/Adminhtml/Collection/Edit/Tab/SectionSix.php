...
class SectionSix extends \Magento\Backend\Block\Widget\Form\Generic implements
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('collection_section_six_');

        $fieldset = $form->addFieldset(
            'section_six_fieldset',
            ['legend' => __('Section 6'), 'class' => 'fieldset-wide']
        );
