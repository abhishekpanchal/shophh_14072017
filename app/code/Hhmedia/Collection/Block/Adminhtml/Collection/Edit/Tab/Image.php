    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'collection_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_collection_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Hhmedia\Collection\Block\Adminhtml\Form\Element\Image'];
    }
}
