 ...
 * Notes data helper
 */
namespace Hhmedia\Notes\Helper;
...
{
    /**
     * Path to store config where count of notes posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'notes/view/items_per_page';
    ...
    /**
     * Remove Notes item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Hhmedia\Notes\Model\Notes $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Notes Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Notes Item images
     *
     * @return string
     */
