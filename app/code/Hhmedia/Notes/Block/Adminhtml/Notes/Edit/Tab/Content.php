    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Hhmedia\NotesModel\Notes */
        ...
        $form->setHtmlIdPrefix('notes_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_notes_edit_tab_content_prepare_form', ['form' => $form]);
