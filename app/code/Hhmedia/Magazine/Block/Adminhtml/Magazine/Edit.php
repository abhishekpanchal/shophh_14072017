...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Hhmedia_Magazine::magazine_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('magazine')->getId()) {
            return __("Edit Magazine '%1'", $this->escapeHtml($this->_coreRegistry->registry('magazine')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('magazine/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
