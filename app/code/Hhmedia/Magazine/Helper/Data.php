...
/**
 * Magazine data helper
 */
namespace Hhmedia\Magazine\Helper;
...
{
    /**
     * Path to store config where count of magazine posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'magazine/view/items_per_page';
    ...
    /**
     * Remove Magazine item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Hhmedia\Magazine\Model\Magazine $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Magazine Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Magazine Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getMagazinePerPage()
    {
    ...
    { 
        return $this->_backendUrl->getUrl('magazine/index/products', ['_current' => true]);
    }
}
