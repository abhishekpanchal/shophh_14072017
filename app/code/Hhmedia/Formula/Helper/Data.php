 ...
 * Formula data helper
 */
namespace Hhmedia\Formula\Helper;
...
{
    /**
     * Path to store config where count of formula posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'formula/view/items_per_page';
    ...
    /**
     * Remove Formula item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Hhmedia\Formula\Model\Formula $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Formula Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Formula Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getFormulaPerPage()
    {
    ...
    { 
        return $this->_backendUrl->getUrl('formula/index/products', ['_current' => true]);
    }
