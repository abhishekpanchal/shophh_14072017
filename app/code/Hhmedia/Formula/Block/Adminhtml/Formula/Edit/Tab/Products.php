...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {   
        ...
        if ($this->getRequest()->getParam('formula_id')) {
    ...
    { 
        $model = $this->_objectManager->get('\Hhmedia\Formula\Model\Formula');
    ...
    protected function _getSelectedProducts()
    {
        ...
        return $formula->getProducts($formula);
    }
    ...
    {
        $formula = $this->getFormula();
        $selected = $formula->getProducts($formula);
    ...
    {
        $formulaId = $this->getRequest()->getParam('formula_id');
