    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'formula_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_formula_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Hhmedia\Formula\Block\Adminhtml\Form\Element\Image'];
    }
}
