    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Hhmedia\FormulaModel\Formula */
        ...
        $form->setHtmlIdPrefix('formula_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_formula_edit_tab_content_prepare_form', ['form' => $form]);
