...
func (service *EstimatingServiceContract) GetQuickEstimate(request *GetQuickEstimateRequestContainer, header interface{}) (*GetQuickEstimateResponseContainer, error) {
	response := &GetQuickEstimateResponseContainer{}
	err := service.client.Call("http://purolator.com/pws/service/v1/GetQuickEstimate", request, response, header)
	if err != nil {
		return nil, err
	}
...
func (service *EstimatingServiceContract) GetFullEstimate(request *GetFullEstimateRequestContainer, header interface{}) (*GetFullEstimateResponseContainer, error) {
	response := &GetFullEstimateResponseContainer{}
	err := service.client.Call("http://purolator.com/pws/service/v1/GetFullEstimate", request, response, header)
	if err != nil {
		return nil, err
	}
