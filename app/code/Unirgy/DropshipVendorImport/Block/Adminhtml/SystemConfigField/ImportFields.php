...
namespace Unirgy\DropshipVendorImport\Block\Adminhtml\SystemConfigField;

use Magento\Config\Block\System\Config\Form\Field;
use Magento\Framework\Data\Form\Element\AbstractElement;

class ImportFields extends Field
{
    ...
    protected function _construct()
    {
        parent::_construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('Unirgy_DropshipVendorImport::uvimport/system/form_field/import_fields.phtml');
        }
    }
