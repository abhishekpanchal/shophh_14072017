...
define(
    ...
    function(
        ...
        return Component.extend({
            defaults: {
                template: 'Unirgy_DropshipSplit/shipping'
            },
            ...
            initialize: function () {
                ...
                registry.async('checkoutProvider')(function (checkoutProvider) {
                    ...
                    if (shippingAddressData && shippingAddressData.postcode) {
            ...
            selectShippingMethod: function(shippingMethod) {
                ...
                if (shippingMethod.udropship_vendor>0) {
                    checkoutData.setSelectedShippingRateByVendor(shippingMethod.carrier_code + '_' + shippingMethod.method_code, shippingMethod.udropship_vendor);
                } else if (shippingMethod.udropship_vendor==0) {
            ...
            validateShippingInformation: function () {
                ...
                if (this.isFormInline) {
                    ...
                    if (this.source.get('params.invalid')
                        || !quote.shippingMethod()[0].method_code
                        || !quote.shippingMethod()[0].carrier_code
