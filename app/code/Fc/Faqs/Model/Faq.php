...
class Faq extends \Magento\Framework\Model\AbstractModel implements FaqInterface, IdentityInterface
{
    ...
    public static function getIdentifier() {
        return [
            '' => __('Please Select'), 
            'order' => __('Orders, Delivery & Returns'), 
            'payment' => __('Credits & Payments'), 
            'gift' => __('Gifts & Gift Certificates'), 
            'product' => __('Products'), 
            'email' => __('Email Subscription'), 
            'account' => __('Account Information'), 
            'other' => __('Other Questions'),
        ];
    }
